...
C(6)=(Hfin-(props.Hmax))*100; % HS fin height limits
C(7)=props.Ta1-Tcpu1; % Ta1 < Tcp1
C(8)=Ta2-Tcpu1; % Ta2 < Tcpu1
C(9)=t1-3e-3; % t1 < 3mm
C(10)=2e-4-t1; % t1 > 0.2mm
C(11)=t2-3e-3; % t2 < 3mm
C(12)=2e-4-t2; % t2 > 0.2mm
C(13)=b1-3e-3; % b1 < 3mm
C(14)=1e-3-b1; % b1 > 1mm
C(15)=b2-3e-3; % b2 < 3mm
C(16)=1e-3-b2; % b2 > 1mm
C(17)=Va-0.02; % Va < 0.02 m3/s (max flow rate by fan)
